...
baseToThePower = pow(baseNumber, powerNumber)
...
percentage = (scoreValue / maxValue) * 100
scorePercentage = (round(percentage, 3))
...
scoreMessage = ("You got a score of") + (" 145")
...
parsedNumber = float(re.sub(r"[^0-9.1]", "", parseTheNumber))
